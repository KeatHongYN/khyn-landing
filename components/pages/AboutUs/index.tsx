    ...
    <MainLayout title="About us - Keat Hong Youth Network">
      <div className="c-About-us">
        ...
        <div className="c-About-us__Hero c-Hero">
          ...
          <p>Since 1998, Keat Hong Youth Network (YN) has been serving residents
            living in the Keat Hong Constituency as well as other beneficiaries.
            Members consist of youths from all walks of life, between ages 15-35
            years old. Our vision is to build social capital amongst youths, and
            through youths to help enrich the lives of others.</p>
        </div>
        ...
        <div className="c-About-us__CD c-CD">
          <div className="c-CD__Top c-Top">
            <h1>Core Domains</h1>
            <p>Keat Hong YN strives to meet the diverse interests of youths,
              through an array of events and projects. Our youths have been
              especially active in these domains</p>
          </div>
