...
import { formatDate, formatPrice, formatTime, recursiveCamelCase } from '../../../utils/helper';
...
const EventsPage = (): JSX.Element => {
  ...
  useEffect(() => {
    ...
    formattedEvents = formattedEvents.map((oneEvent: SingularRawCamelCasedEvent) => ({
      ...oneEvent,
          ...
          <span key={index}>
            <EventListItemSkeleton />
            {
              index !== MOCK_EVENTS.length - 1 ?
                <hr className="c-List__HR c-HR" /> : null
            }
          </span>
