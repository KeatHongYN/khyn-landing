...
import { FLAG_BANNER_META, FLAG_BANNER_VARIATION_ENUM } from '../../../config/constants';
...
const FlagBanner = ({
    ...
    return (
        <div className={`c-Flag-banner c-Flag-banner__${classSuffix} ${isMobile ? "c-Flag-banner--mobile" : ""}`}>
