...
const Hamburger = ({ openMenu, setOpenMenu }: HamburgerProps): JSX.Element  => {
    ...
    return (
        <div className={`c-Hamburger ${openMenu && "c-Hamburger--open"}`} onClick={handleHamburgerClick}>
            <span></span>
            <span></span>
            <span></span>
            <span></span>
...
const HeaderMobile = (): JSX.Element  => {
    ...
    return (
        <div className="c-Header-mobile">
            ...
            <div className={`c-Header-mobile__Menu c-Menu ${openMenu && "c-Header-mobile__Menu--show"}`}>
                <Link href="/">Home</Link>
